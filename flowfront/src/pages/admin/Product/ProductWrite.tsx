...
import { adminProductWriteSubmit, adminProductUpdateSubmit, getProductInfo } from "../../../api/product";
...
const ProductWrite = () => {
  ...
  const submit = async () => {
    ...
    if (isEdit && pid) {
      await adminProductUpdateSubmit(pid, name, description, category, image, priceNum, stockNum);
    } else {
      await adminProductWriteSubmit(name, description, category, image, priceNum, stockNum);
    }
